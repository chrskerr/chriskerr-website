...
export default function Landing (): ReactElement {	
	return (
		<>
			...
			<section className="w-full">
				<div className="grid grid-cols-1 gap-16 grid-rows-auto display-width divider-before">
					<Link href="/editor" passHref>
						<a>
							<div className="group relative shadow-lg rounded-2xl aspect-[5/3] border overflow-hidden transform-fix">
								...
								/>
								<p className="absolute flex items-center justify-center px-5 py-3 text-2xl -translate-x-1/2 -translate-y-1/2 bg-white rounded top-1/2 left-1/2">Collaborative Markdown Editor</p>
							</div>
						</a>
					</Link>
				</div>
