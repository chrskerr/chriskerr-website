...
export const processDeleteMany = ({
	...
	const startCursorPos = getCursorPosFromRowCol(
		selectedTextStart,
		dataAsRows,
	);
	...
	if (startIndex === undefined || endIndex === undefined || !updatedCursorPos)
		return null;

	const deletedCells = updatedData.cells.splice(
		startIndex,
		adjustedEndIndex - startIndex,
	);
